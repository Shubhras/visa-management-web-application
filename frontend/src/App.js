...
import WorkRightsDuringVacationList from "./pages/masters/visaConditionsMaster/workRightsDuringVacation/WorkRightsDuringVacationList";
import WorkRightsAfterStudyList from "./pages/masters/visaConditionsMaster/workRightsAfterStudy/WorkRightsAfterStudyList";
import PRPossibilityList from "./pages/masters/visaConditionsMaster/PRPossibility/PRPossibilityList";
import SpouseCanApplywithCandidateList from "./pages/masters/visaConditionsMaster/spouseCanApplywithCandidate/SpouseCanApplywithCandidateList";
import SpouseVisaCategoryList from "./pages/masters/visaConditionsMaster/spouseVisaCategory/SpouseVisaCategoryList";
import SpouseWorkRightsList from "./pages/masters/visaConditionsMaster/spouseWorkRights/SpouseWorkRightsList";
import ChildrenCanApplywithCandidateList from "./pages/masters/visaConditionsMaster/childrenCanApplywithCandidate/ChildrenCanApplywithCandidateList";
    ...
    <BrowserRouter>
      ...
      <GlobalSearchProvider>
        <Routes>
          ...
          <Route path="/work-rights" element={<ProtectedRoute><WorkRightsList /></ProtectedRoute>}></Route>
          <Route path="/work-rights-during-study" element={<ProtectedRoute><WorkRightsDuringStudyList /></ProtectedRoute>}></Route>
          <Route path="/work-rights-during-vacation" element={<ProtectedRoute><WorkRightsDuringVacationList /></ProtectedRoute>}></Route>
          <Route path="/work-rights-after-study" element={<ProtectedRoute><WorkRightsAfterStudyList /></ProtectedRoute>}></Route>
          <Route path="/pr-possibility" element={<ProtectedRoute><PRPossibilityList /></ProtectedRoute>}></Route>
          <Route path="/spouse-can-apply-with-candidate" element={<ProtectedRoute><SpouseCanApplywithCandidateList /></ProtectedRoute>}></Route>
          <Route path="/spouse-visa-category" element={<ProtectedRoute><SpouseVisaCategoryList /></ProtectedRoute>}></Route>
          <Route path="/spouse-work-rights" element={<ProtectedRoute><SpouseWorkRightsList /></ProtectedRoute>}></Route>
