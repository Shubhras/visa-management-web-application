...
export const getEmployeeTypeListDataAPI = (data) => {
  ...
  const apiUrl = `${url.GET_EMPLOYEE_TYPE_LIST}?search=${data?.search}&page=${data?.page}&limit=${data?.limit}&sortBy=${data?.sortBy}&sortOrder=${data?.sortOrder}&customSort=${customSort}`;
  return get(apiUrl);
};
...
export const getCompanyListDataAPI = (data) => {
  ...
  const apiUrl = `${url.GET_COMPANY_LIST}?search=${data?.search}&page=${data?.page}&limit=${data?.limit}&sortBy=${data?.sortBy}&sortOrder=${data?.sortOrder}&customSort=${customSort}`;
  return get(apiUrl);
};
...
export const getStakeholderCategoryListDataAPI = (data) => {
  ...
  const apiUrl = `${url.GET_STAKEHOLDER_CATEGORY_LIST}?search=${data?.search}&page=${data?.page}&limit=${data?.limit}&sortBy=${data?.sortBy}&sortOrder=${data?.sortOrder}&customSort=${customSort}`;
  return get(apiUrl);
};
...
export const exportStakeholderCategoryDataAPI = (payload) => {
  ...
  const apiUrl = `${url.EXPORT_STAKEHOLDER_CATEGORY_API}?search=${payload?.search}&fields=${payload?.fields}&uuids=${payload?.uuids}&customSort=${customSort}`;
  return getExportData(apiUrl, payload);
};
...
export const getStakeholderTypeListDataAPI = (data) => {
  ...
  const apiUrl = `${url.GET_STAKEHOLDER_TYPE_LIST}?search=${data?.search}&page=${data?.page}&limit=${data?.limit}&sortBy=${data?.sortBy}&sortOrder=${data?.sortOrder}&category=${data?.category}&customSort=${customSort}`;
  return get(apiUrl);
};
...
export const exportStakeholderTypeDataAPI = (payload) => {
  ...
  const apiUrl = `${url.EXPORT_STAKEHOLDER_TYPE_API}?search=${payload?.search}&fields=${payload?.fields}&uuids=${payload?.uuids}&category=${payload?.category}&customSort=${customSort}`;
  return getExportData(apiUrl, payload);
};
...
export const getAccreditationCategoryListDataAPI = (data) => {
  ...
  const apiUrl = `${url.GET_ACCREDITATION_CATEGORY_LIST}?search=${data?.search}&page=${data?.page}&limit=${data?.limit}&sortBy=${data?.sortBy}&sortOrder=${data?.sortOrder}&customSort=${customSort}`;
  return get(apiUrl);
};
...
export const exportAccreditationCategoryDataAPI = (payload) => {
  ...
  const apiUrl = `${url.EXPORT_ACCREDITATION_CATEGORY_API}?search=${payload?.search}&fields=${payload?.fields}&uuids=${payload?.uuids}&customSort=${customSort}`;
  return getExportData(apiUrl, payload);
};
...
export const deleteStudyMajorAreaDataAPI = (payload) => {
  const prepareDATA = {
   ...
   const apiUrl = `${url.DELETE_STUDY_MAJOR_AREA_API}delete/?search=${payload?.search}&studyMainArea=${payload?.studyMainArea}`;
  return delWithPayload(apiUrl, prepareDATA);
  // const prepareDATA = {
  //   id: payload,
  // };
...
export const deleteAcademicResultTypeDataAPI = (payload) => {
  ...
  const apiUrl = `${url.DELETE_ACADEMIC_RESULT_TYPE_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA)
};
...
export const deleteEducationTypeDataAPI = (payload) => {
  ...
  const apiUrl = `${url.DELETE_EDUCATION_TYPE_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteStudySpecialisationDataAPI = (payload) => {
  const prepareDATA = {
   ...
   const apiUrl = `${url.DELETE_STUDY_SPECIALISATION_API}delete/?search=${payload?.search}&studyMainArea=${payload?.studyMainArea}}&studyMajorArea=${payload?.studyMajorArea}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteDegreeAwardedByDataAPI = (payload) => {
  const prepareDATA = {
   ...
   const apiUrl = `${url.DELETE_DEGREE_AWARDED_BY_API}delete/?search=${payload?.search}&country=${payload?.country}}&educationLevel=${payload?.educationLevel}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteJobTypeDataAPI = (payload) => {
 ...
 const apiUrl = `${url.DELETE_JOB_TYPE_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteModeOfSalaryDataAPI = (payload) => {
  ...
  const apiUrl = `${url.DELETE_MODE_OF_SALARY_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteItReturnStatusDataAPI = (payload) => {
  ...
  const apiUrl = `${url.DELETE_IT_RETURN_STATUS_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteOccupationTypeDataAPI = (payload) => {
  ...
  const apiUrl = `${url.DELETE_OCCUPATION_TYPE_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteOccupationProspectDataAPI = (payload) => {
  ...
  const apiUrl = `${url.DELETE_OCCUPATION_PROSPECT_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteOccupationCategoryDataAPI = (payload) => {
  ...
  const prepareDATA = {
   ...
   const apiUrl = `${url.DELETE_OCCUPATION_CATEGORY_API}delete/?search=${payload?.search}&occupationVersion=${payload?.occupationVersion}&representingCountry=${payload?.representingCountry}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const deleteOccupationVersionDataAPI = (payload) => {
  const prepareDATA = {
   ...
   const apiUrl = `${url.DELETE_OCCUPATION_VERSION_API}delete/?search=${payload?.search}&representingCountry=${payload?.representingCountry}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const editWorkRightsAfterStudyAPI = (payload) => {
  return put(
    `${url.EDIT_WORK_RIGHTS_AFTER_STUDY_API}${payload.uuid}/update/`,
    payload
  );
};
...
export const editSpouseApplyWithCandidateAPI = (payload) => {
  return put(
    `${url.EDIT_SPOUSE_APPLY_WITH_CANDIDATE_API}${payload.uuid}/update/`,
    payload
  );
};
...
export const getVisaMainCategoryListAPI = (data) => {
  ...
  const apiUrl = `${url.GET_VISA_MAIN_CATEGORY_LIST}?search=${data?.search}&page=${data?.page}&limit=${data?.limit}&sortBy=${data?.sortBy}&sortOrder=${data?.sortOrder}&customSort=${customSort}`;
  return get(apiUrl);
};
...
export const exportVisaMainCategoryAPI = (payload) => {
  ...
  const apiUrl = `${url.EXPORT_VISA_MAIN_CATEGORY_API}?search=${payload?.search}&fields=${payload?.fields}&uuids=${payload?.uuids}&customSort=${customSort}`;
  return getExportData(apiUrl, payload);
};
...
export const deleteDocumentCategoryAPI = (payload) => {
  ...
  const apiUrl = `${url.DELETE_DOCUMENT_CATEGORY_API}delete/?search=${payload?.search}`;
  return delWithPayload(apiUrl, prepareDATA);
};
...
export const editVisaMajorCategoryAPI = (payload) => {
  return put(
    `${url.EDIT_VISA_MAJOR_CATEGORY_API}${payload?.uuid}/update/`,
    payload
  );
};
