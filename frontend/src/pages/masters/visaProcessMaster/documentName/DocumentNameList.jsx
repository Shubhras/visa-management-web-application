...
import { documentNameList, documentNameDelete, documentNameExportData } from "../../../../store/master/visaProcessMaster/action";
...
const DocumentNameList = () => {
    ...
    const [tableColumns] = useState([
        { id: 'documentCategory', label: 'Document Category', field: 'documentCategory', visible: true, required: false },
        { id: 'name', label: 'Document Name', field: 'name', visible: true, required: false },
