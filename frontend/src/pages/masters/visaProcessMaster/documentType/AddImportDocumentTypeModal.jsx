...
import { documentTypeImportData } from "../../../../store/master/visaProcessMaster/action";
...
const AddImportDocumentTypeModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(documentTypeImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Document Type skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "DocumentType",
                    items: ["Document Type", "Description"],
                    selectedItems: ["Document Type"],
                    ItemsRequired: ["Document Type"]
                }
                } />
            )}
        </>
...
export default AddImportDocumentTypeModal;