...
const ProcessStatusNameList = () => {
    ...
    const [tableColumns] = useState([
        ...
        { id: 'visaMajor', label: 'Process Status Name', field: 'visaMajor', visible: true, required: false },
    ...
    const confirmDelete = () => {
        ...
        if (!sendPayload || sendPayload.length === 0) {
            toast.error("No Process Status Name selected for deletion.");
            return;
        }
        dispatch(processStatusNameDelete(sendPayload, (response, error) => {
            if (error) {
