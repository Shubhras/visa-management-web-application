...
import { processStatusNameAdd, processStatusNameEdit } from "../../../../store/master/visaProcessMaster/action";
...
const AddEditProcessStatusNameModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.name.trim()) {
            newErrors.name = 'Process Status Name is required';
            isValid = false;
        }
        if (!formData.country) {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            const sendPayload = mode === 'edit'
                ? {
                    uuid: formData.uuid,
                    process_status_name: formData.name,
            ...
            const action = mode === 'edit' ? processStatusNameEdit : processStatusNameAdd;
...
export default AddEditProcessStatusNameModal;