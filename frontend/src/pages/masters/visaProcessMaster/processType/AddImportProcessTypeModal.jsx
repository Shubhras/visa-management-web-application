...
import { processTypeImportData } from "../../../../store/master/visaProcessMaster/action";
...
const AddImportProcessTypeModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(processTypeImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Process Types skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "ProcessType",
                    items: ["Process Type", "Description"],
                    selectedItems: ["Process Type"],
                    ItemsRequired: ["Process Type"]
                }
                } />
            )}
        </>
...
export default AddImportProcessTypeModal;