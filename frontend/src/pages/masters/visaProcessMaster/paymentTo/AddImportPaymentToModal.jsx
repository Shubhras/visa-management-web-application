...
import { paymentToImportData } from "../../../../store/master/visaProcessMaster/action";
...
const AddImportPaymentToModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(paymentToImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Payment To skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "PaymentTo",
                    items: ["Payment To", "Description"],
                    selectedItems: ["Payment To"],
                    ItemsRequired: ["Payment To"]
                }
                } />
            )}
        </>
...
export default AddImportPaymentToModal;