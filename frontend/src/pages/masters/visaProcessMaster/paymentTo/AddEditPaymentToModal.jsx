...
import { paymentToAdd, paymentToEdit } from "../../../../store/master/visaProcessMaster/action";
import { toast } from "react-toastify";

const AddEditPaymentToModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.departmentName.trim()) {
            newErrors.departmentName = 'Payment To is required';
            isValid = false;
        }
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            const action = mode === 'edit' ? paymentToEdit : paymentToAdd;
                ...
                <div className="modal-content radius-16 bg-base">
                    <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                        <h1 className="modal-title fs-5" id="departmentModalLabel">
                            {mode === 'edit' ? 'Edit  Payment To' : 'Add  Payment To'}
                        </h1>
                        <button
                            type="button"
                            className="btn-close"
...
export default AddEditPaymentToModal;