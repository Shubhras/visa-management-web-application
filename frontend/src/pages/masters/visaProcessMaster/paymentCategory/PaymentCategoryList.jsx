...
const PaymentCategoryList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Payment Category?");
    ...
    const [items] = useState(["Payment To", "Payment Category", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Payment To", "Payment Category"]);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Payment Category?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Payment Category` : `${selectedRows.length} selected Payment Category`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Payment Category (${message})?`);
        setShowDeleteConfirm(true);
    };
        ...
        dispatch(paymentCategoryExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `PaymentCategory.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                                        ...
                                        departments.map((rowItem, index) => (
                                            <tr key={rowItem.uuid}>
                                                ...
                                                {isColumnVisible('name') && (
                                                    <td><span>{rowItem.payment_category}</span></td>
                                                )}
                ...
                {/* Import Modal */}
                {showImport && (
                    <AddImportPaymentCategoryModal show={showImport} handleClose={handleCloseImport} />
                )}
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Payment Category</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default PaymentCategoryList;