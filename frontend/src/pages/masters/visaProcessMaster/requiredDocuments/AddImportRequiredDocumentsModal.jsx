...
import { requiredDocumentGeneralImportData } from "../../../../store/master/visaProcessMaster/action";
...
const AddImportRequiredDocumentsModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(requiredDocumentGeneralImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Required Documents (General) skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Documents For"],
                            sheetName: "RequiredDocuments(General)",
                            fileName: "RequiredDocuments(General)",
                        };
        ...
        <>
                    ...
                    <div className="modal-content radius-16 bg-base">
                        <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                            <h1 className="modal-title fs-5" id="departmentModalLabel">
                                Upload Required Documents (General)
                            </h1>
                            <button
                                type="button"
                                className="btn-close"
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "RequiredDocuments(General)",
                    items: ["Documents For", "Country", "Visa Main Category", "Visa Major Category", "Description"],
                    selectedItems: ["Documents For"],
                    ItemsRequired: ["Documents For"]
                }
                } />
            )}
        </>
...
export default AddImportRequiredDocumentsModal;