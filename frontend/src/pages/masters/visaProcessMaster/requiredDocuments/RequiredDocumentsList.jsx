...
import { requiredDocumentGeneralList, requiredDocumentGeneralDelete, requiredDocumentGeneralExportData } from "../../../../store/master/visaProcessMaster/action";
...
const RequiredDocumentsList = () => {
    ...
    const [tableColumns] = useState([
        { id: 'name', label: 'Documents For', field: 'name', visible: true, required: false },
    ...
    const confirmDelete = () => {
        ...
        if (!sendPayload || sendPayload.length === 0) {
            toast.error("No Required Documents (General) selected for deletion.");
            return;
        }
        dispatch(requiredDocumentGeneralDelete(sendPayload, (response, error) => {
            if (error) {
