...
const AddEditRequiredDocumentsModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.name.trim()) {
            newErrors.name = 'Documents For is required';
            isValid = false;
        }
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            const action = mode === 'edit' ? requiredDocumentGeneralEdit : requiredDocumentGeneralAdd;
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-12 mb-10">
                                    ...
                                    <Select
                                        options={documentFor.map((option) => ({
                                            value: option.uuid,
                                            label: option.name,
                                        }))}
                                        value={
...
export default AddEditRequiredDocumentsModal;