...
import { purposeOfVisitList, purposeOfVisitDelete, purposeOfVisitExportData } from "../../../../store/master/visaProcessMaster/action";
import AddImportPurposeofVisitModal from './AddImportPurposeofVisitModal';
import AddEditPurposeofVisitModal from './AddEditPurposeofVisitModal';
...
const  PurposeofVisitList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Purpose of Visit?");
    ...
    const [items] = useState(["Purpose of Visit", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Purpose of Visit"]);
    const [ItemsRequired] = useState(["Purpose of Visit"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Purpose of Visit', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(purposeOfVisitList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Purpose of Visit?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Purpose of Visit` : `${selectedRows.length} selected Purpose of Visit`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Purpose of Visit (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const confirmDelete = () => {
        ...
        if (!sendPayload || sendPayload.length === 0) {
            toast.error("No Purpose of Visit selected for deletion.");
            return;
        }
        dispatch(purposeOfVisitDelete(sendPayload, (response, error) => {
            if (error) {
    ...
    const handleExport = () => {
        ...
        dispatch(purposeOfVisitExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `PurposeofVisit.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                />
                {showImport && (
                    <AddImportPurposeofVisitModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Purpose of Visit</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default PurposeofVisitList;