...
import { representingCountryImportData } from "../../../../store/master/visaMaster/action";
...
const AddImportRepresentingCountryModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(representingCountryImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
...
export default AddImportRepresentingCountryModal;