...
import { visaStatusImportData } from '../../../../store/master/visaMaster/action';
import { exportToExcelDuplicate, exportToExcelWrongData } from '../../../../helper/utils/commanHelper';
const AddImportVisaStatusModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(visaStatusImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Visa Status skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "VisaStatus",
                    items: ["Visa Status", "Description"],
                    selectedItems: ["Visa Status"],
                    ItemsRequired: ["Visa Status"]
                }
                } />
            )}
        </>
...
export default AddImportVisaStatusModal;