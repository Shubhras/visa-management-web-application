...
import { visaNameAdd, visaNameEdit } from '../../../../store/master/visaMaster/action';
...
const AddEditVisaNameModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.visaMajorCategory) {
            newErrors.visaMajorCategory = "Visa Major Category is required";
            isValid = false;
        }
        if (!formData.name) {
        ...
        if (validateForm()) {
            const sendPayload = mode === 'edit'
                ? {
                    ...
                    visaMajorCategory: formData.visaMajorCategory,
                    visaShortName: formData.visaShortName,
            ...
            const action = mode === 'edit' ? visaNameEdit : visaNameAdd;
                ...
                <div className="modal-content radius-16 bg-base">
                    <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                        <h1 className="modal-title fs-5" id="GenderModalLabel">
                            {mode === 'edit' ? 'Edit Visa Name' : 'Add Visa Name'}
                        </h1>
                        <button
                            type="button"
                            className="btn-close"
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-12 mb-10">
                                    ...
                                    <input
                                        type="text"
                                        name="visaMajorCategory"
                                        value={formData.visaMajorCategory}
                                        onChange={handleChange}
                                        className={`form-control radius-8 ${errors.visaMajorCategory ? 'is-invalid' : ''}`}
                                        placeholder="Enter Visa Major Category"
                                    />
                                    {errors.visaMajorCategory && (
                                ...
                                <div className="col-12 mb-10">
                                    ...
                                    <input
                                        type="text"
                                        name="visaShortName"
                                        value={formData.visaShortName}
                                        onChange={handleChange}
                                        className={`form-control radius-8 ${errors.visaShortName ? 'is-invalid' : ''}`}
                                        placeholder="Enter Visa short name"
                                    />
                                    {errors.visaShortName && (
                                        <div className="text-danger text-sm mt-1">
                                            {errors.visaShortName}
                                        </div>
                                    )}
...
export default AddEditVisaNameModal;