...
import AddImportVisaNameModal from './AddImportVisaNameModal';
import AddEditVisaNameModal from './AddEditVisaNameModal';
...
const VisaNameList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Visa Name?");
    ...
    const [items] = useState(["Country", "Visa Main Category", "Visa Major Category", "Visa Name", "Visa Short Name", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Country", "Visa Main Category", "Visa Major Category", "Visa Name"]);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Visa Name?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Visa Name` : `${selectedRows.length} selected Visa Name`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Visa Name (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(visaNameExportData(sendPayload, (response, error) => {
            if (error) {
    ...
    return (
        <>
            <MasterLayout>
                ...
                />
                {showImport && (
                    <AddImportVisaNameModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Visa Name</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
