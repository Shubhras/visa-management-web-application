  ...
  useEffect(() => {
    if (mode === "edit" && rowData) {
      setFormData({
        ...
        occupationLevelCode: rowData.occupationlevelcode || "",
        occupationCategory: rowData.occupationCategory || "",
        occupationLevelName: rowData.occupationLevelName || "",
      ...
      const sendPayload =
        mode === "edit"
          ? {
              ...
              occupation_level_code_id: formData.occupationLevelCode,
              occupation_category_id: formData.occupationCategory,
          ...
          : {
              ...
              occupationtype_id: formData.occupationCategory,
              occupationlevel: formData.occupationLevelName,
              description: formData.description,
            };
                    ...
                    value={
                      formData.occupationLevelCode
                        ? occupationLevelCodeData
                            ...
                            .find(
                              (opt) => opt.value === formData.occupationLevelCode
                            )
                        : null
                    }
                    onChange={(selectedOption) =>
