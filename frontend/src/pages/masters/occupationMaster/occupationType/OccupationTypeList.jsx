...
import AddImportOccupationTypeModal from './AddImportOccupationTypeModal';
import AddEditOccupationTypeModal from './AddEditOccupationTypeModal';
...
const OccupationTypeList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this occupation type?");
    ...
    const [items] = useState(["Occupation Type", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Occupation Type"]);
    const [ItemsRequired] = useState(["Occupation Type"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Occupation Type', field: 'name', visible: true, required: false },
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this occupation type?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all occupation type` : `${selectedRows.length} selected occupation types`;
        setDeleteConfirmMessage(`Are you sure you want to delete this occupation type (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const confirmDelete = () => {
        ...
        dispatch(occupationTypeDelete(payloadSend, (response, error) => {
            if (error) {
    ...
    return (
        <>
            <MasterLayout>
                ...
                />
                {showImport && (
                    <AddImportOccupationTypeModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Occupation Type</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
