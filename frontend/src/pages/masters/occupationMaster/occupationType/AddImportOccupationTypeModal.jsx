...
const AddImportOccupationTypeModal = ({ show, handleClose }) => {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate occupation type skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Occupation Type"],
                            sheetName: "OccupationType",
                            fileName: "OccupationType",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Occupation Type", "Description", "Reason"],
                            sheetName: "OccupationType",
                            fileName: "OccupationType",
                        };
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "OccupationType",
                    items: ["Occupation Type", "Description"],
                    selectedItems: ["Occupation Type"],
                    ItemsRequired: ["Occupation Type"]
                }
                } />
            )}
        </>
...
export default AddImportOccupationTypeModal;