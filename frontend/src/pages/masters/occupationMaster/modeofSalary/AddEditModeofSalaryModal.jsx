...
import { modeOfSalaryAdd, modeOfSalaryEdit } from "../../../../store/master/occupationMaster/action";
import { toast } from "react-toastify";

const AddEditModeofSalaryModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.departmentName.trim()) {
            newErrors.departmentName = 'Mode of salary is required';
            isValid = false;
        }
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            const action = mode === 'edit' ? modeOfSalaryEdit : modeOfSalaryAdd;
                ...
                <div className="modal-content radius-16 bg-base">
                    <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                        <h1 className="modal-title fs-5" id="departmentModalLabel">
                            {mode === 'edit' ? 'Edit Mode of Salary' : 'Add Mode of Salary'}
                        </h1>
                        <button
                            type="button"
                            className="btn-close"
...
export default AddEditModeofSalaryModal;