...
import {
  ...
  occupationCategoryDelete,
  occupationCategoryExportData,
  occupationVersionList,
  representingCountryList,
} from "../../../../store/master/occupationMaster/action";
import { formatDateDDMMYYYYTime } from "../../../../helper/utils/commanHelper";
import AddImportOccupationCategory from "./AddImportOccupationCategory";
import AddEditOccupationCategory from "./AddEditOccupationCategor";
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
import ResetButton from '../../../../components/comman/ResetButton';
const OccupationCategoryList = () => {
  ...
  const [deleteConfirmMessage, setDeleteConfirmMessage] = useState(
    "Are you sure you want to delete this occupation type?"
  );
  ...
  const handleBulkDelete = () => {
    ...
    const message =
      selectAllOrNot === "all"
        ? `${tableState.total} all occupation type`
        : `${selectedRows.length} selected occupation types`;
    setDeleteConfirmMessage(
      `Are you sure you want to delete this occupation type (${message})?`
    );
    setShowDeleteConfirm(true);
  };
  ...
  const confirmDelete = () => {
    ...
    dispatch(
      occupationCategoryDelete(payloadSend, (response, error) => {
        if (error) {
  ...
  const handleExport = () => {
    ...
    dispatch(
      occupationCategoryExportData(sendPayload, (response, error) => {
        if (error) {
...
export default OccupationCategoryList;
