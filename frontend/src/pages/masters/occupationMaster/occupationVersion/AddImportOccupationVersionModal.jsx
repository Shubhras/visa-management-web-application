...
const AddImportOccupationVersionModal = ({ show, handleClose }) => {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate occupation version skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Occupation Version"],
                            sheetName: "OccupationVersion",
                            fileName: "OccupationVersion",
                        };
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "OccupationVersion",
                    items: ["Start Date", "End Date", "Country", "Occupation Version", "Description"],
                    selectedItems: ["Start Date", "Country", "Occupation Version"],
                    ItemsRequired: ["Start Date", "Country", "Occupation Version"]
                }
                } />
            )}
        </>
...
export default AddImportOccupationVersionModal;