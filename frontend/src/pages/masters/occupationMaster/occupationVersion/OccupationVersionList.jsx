...
import { occupationVersionList, occupationVersionDelete, occupationVersionExportData, representingCountryList } from "../../../../store/master/occupationMaster/action";
...
const OccupationVersionList = () => {
    ...
    const [tableColumns] = useState([
        ...
        { id: 'name', label: 'Occupation Version', field: 'name', visible: true, required: false, filterable: false },
        { id: 'description', label: 'Description', field: 'description', visible: true, required: false, filterable: false },
        { id: 'startDate', label: 'Start Date', field: 'startDate', visible: true, required: false, filterable: false },
        { id: 'endDate', label: 'End Date', field: 'endDate', visible: true, required: false, filterable: false },
    ...
    const confirmDelete = () => {
        ...
        dispatch(occupationVersionDelete(payloadSend, (response, error) => {
            if (error) {
