...
import {
  occupationVersionAdd,
  occupationVersionEdit,
  representingCountryList,
} from "../../../../store/master/occupationMaster/action";
import { toast } from "react-toastify";
import Select from "react-select";

const AddEditOccupationVersionModal = ({
  show,
  handleClose,
  mode = "add",
  rowData = null,
  ...
  const handleSubmit = (e) => {
    ...
    const action =
      mode === "edit" ? occupationVersionEdit : occupationVersionAdd;
        ...
        <div className="modal-content radius-16 bg-base">
          <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
            <h1 className="modal-title fs-5">
              {mode === "edit"
                ? "Edit Occupation Version"
                : "Add Occupation Version"}
            </h1>
