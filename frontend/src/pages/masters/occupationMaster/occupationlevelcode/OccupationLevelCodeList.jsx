...
import {
  occupationLevelCodeDelete,
  occupationLevelCodeExportData,
  occupationLevelCodeList,
  occupationVersionList,
  representingCountryList,
} from "../../../../store/master/occupationMaster/action";
import AddImportOccupationLevelCode from "./AddImportOccupationLevelCode";
import AddEditOccupationLevelCode from "./AddEditOccupationLevelCode";
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
import ResetButton from '../../../../components/comman/ResetButton';
const OccupationLevelCodeList = () => {
  ...
  const [deleteConfirmMessage, setDeleteConfirmMessage] = useState(
    "Are you sure you want to delete this occupation level code?"
  );
  ...
  const fetchOccupationLevelCodeList = () => {
    setLoading(true);
    const params = {
  ...
  const confirmDelete = () => {
    ...
    dispatch(
      occupationLevelCodeDelete(payloadSend, (response, error) => {
        if (error) {
  ...
  const handleExport = () => {
    ...
    dispatch(
      occupationLevelCodeExportData(sendPayload, (response, error) => {
        if (error) {
...
export default OccupationLevelCodeList;
