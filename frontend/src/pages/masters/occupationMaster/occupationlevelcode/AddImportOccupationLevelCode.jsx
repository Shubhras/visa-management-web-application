...
const AddImportOccupationLevelCode = ({ show, handleClose }) => {
          ...
          if (response?.statusCode === 200 && response?.status === true) {
              ...
              <div>
                ...
                {response?.duplicates?.length > 0 && (
                  <div style={{ marginTop: "6px" }}>
                    <strong>
                      Duplicate Occupation Level Code skipped — the duplicate data from
            ...
            if (response?.duplicates?.length > 0) {
              const prepareData = {
                ...
                sheetName: "Occupation Level Code",
                fileName: "Occupation Level Code",
              };
  ...
  return (
    <>
      <div
        ...
        tabIndex={-1}
        role="dialog"
        aria-labelledby="OccupationLevelCodeModalLabel"
        aria-hidden={!show}
      >
        <div
      ...
      {showSampleExcelDownload && (
        <CommanSampleExcelDownloadModal
          ...
          prepareData={{
            downloadFileName: "Occupation Level Code",
            items: [
              "Country",
              "Occupation Version",
              "Occupation Level Code",
...
export default AddImportOccupationLevelCode;
