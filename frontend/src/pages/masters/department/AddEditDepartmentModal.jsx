...
import { departmentAdd, departmentEdit } from '../../../store/master/actions';
import { toast } from "react-toastify";

const AddEditDepartmentModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      const action = mode === 'edit' ? departmentEdit : departmentAdd;
