...
import { languageTestResultImportData } from '../../../../store/master/testMaster/action';
...
const AddImportLanguageTestResultModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(languageTestResultImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate language test result skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result"],
                            sheetName: "LanguageTestResult",
                            fileName: "LanguageTestResult",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result", "Reason"],
                            sheetName: "LanguageTestResult",
                            fileName: "LanguageTestResult",
                        };
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "LanguageTestResult",
                    items: ["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result", "Language Banchmark Level", "Description"],
                    selectedItems: ["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result",],
                    ItemsRequired: ["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result",]
                }
                } />
            )}
        </>
...
export default AddImportLanguageTestResultModal;