...
import { languageTestResultList, languageTestResultDelete, languageTestResultExportData } from '../../../../store/master/testMaster/action';
...
const LanguageTestResultList = () => {
    ...
    const [tableColumns] = useState([
        { id: 'languageNameTest', label: 'Language Name (Test)', field: 'languageNameTest', visible: true, required: true },
        { id: 'languageTestName', label: 'Language Test Name', field: 'languageTestName', visible: true, required: true },
        { id: 'moduleName', label: 'Module Name', field: 'moduleName', visible: true, required: true },
        { id: 'languageTestResult', label: 'Language Test Result', field: 'languageTestResult', visible: true, required: true },
        { id: 'languageBenchmark', label: 'Language Banchmark Level', field: 'languageBenchmark', visible: true, required: false },
