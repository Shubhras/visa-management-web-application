...
import {
    languageTestResultList, languageTestResultDelete, languageTestResultExportData,
    languageNameTestList, languageTestNameList, languageTestModuleNameList, languageBenchmarkLevelList
} from '../../../../store/master/testMaster/action';
import AddImportLanguageTestResultModal from './AddImportLanguageTestResultModal';
...
const LanguageTestResultList = () => {
    ...
    useEffect(() => {
        fetchLanguageNameTestDropdown();
        fetchLanguageTestNameDropdown();
        fetchLanguageTestModuleNameDropdown();
        fetchLanguageBenchmarkLevelDropdown();
    }, []);
    const fetchLanguageNameTestDropdown = () => {
        const params = {
            page: 1,
            limit: 2000,
            search: "",
        ...
        dispatch(languageNameTestList(params, (response, error) => {
            if (response?.statusCode === 200 && response?.status === true) {
                ...
                setFilterDropdownData(prev => ({
                    ...prev,
                    languageNameTest: sortedOptions
                }));
    ...
    const fetchLanguageTestModuleNameDropdown = () => {
        ...
        dispatch(languageTestModuleNameList(params, (response, error) => {
            if (response?.statusCode === 200 && response?.status === true) {
                ...
                setFilterDropdownData(prev => ({
                    ...prev,
                    languageModuleName: sortedOptions
                }));

            }
        }));
    };
    const fetchLanguageBenchmarkLevelDropdown = () => {
        const params = {
            page: 1,
            limit: 2000,
            search: "",
        ...
        dispatch(languageBenchmarkLevelList(params, (response, error) => {
            if (response?.statusCode === 200 && response?.status === true) {
                ...
                setFilterDropdownData(prev => ({
                    ...prev,
                    languageBanchMarkLevel: sortedOptions
                }));
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this language test result?");
    ...
    const [items] = useState(["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result", "Language Banchmark Level", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result"]);
    const [ItemsRequired] = useState(["Language Name (Test)", "Language Test Name", "Module Name", "Language Test Result"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'languageNameTest', label: 'Language Name (Test)', field: 'languageNameTest', visible: true, required: false, filterable: true },
        { id: 'languageTestName', label: 'Language Test Name', field: 'languageTestName', visible: true, required: false, filterable: true },
        { id: 'moduleName', label: 'Module Name', field: 'languageModuleName', visible: true, required: false, filterable: true },
        { id: 'languageBenchmark', label: 'Language Banchmark Level', field: 'languageBanchMarkLevel', visible: true, required: false, filterable: true },
        { id: 'languageTestResult', label: 'Language Test Result', field: 'languageTestResult', visible: true, required: false, filterable: false },
    ...
    const fetchDepartmentList = () => {
        ...
        const params = {
            ...
            languageNameTest: columnFilters.languageNameTest.length > 0 ? columnFilters.languageNameTest : null,
            languageTestName: columnFilters.languageTestName.length > 0 ? columnFilters.languageTestName : null,
            languageModuleName: columnFilters.languageModuleName.length > 0 ? columnFilters.languageModuleName : null,
            languageBanchMarkLevel: columnFilters.languageBanchMarkLevel.length > 0 ? columnFilters.languageBanchMarkLevel : null,
        };
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this language test result?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all language test results` : `${selectedRows.length} selected language test result`;
        setDeleteConfirmMessage(`Are you sure you want to delete this language test result (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(languageTestResultExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `LanguageTestResult.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditLanguageTestResultModal
                ...
                />
                {showImport && (
                    <AddImportLanguageTestResultModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Language Test Result</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default LanguageTestResultList;