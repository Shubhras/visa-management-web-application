...
import { entranceTestNameList, entranceTestNameDelete, entranceTestNameExportData } from '../../../../store/master/testMaster/action';
import AddImportEntranceTestNameModal from './AddImportEntranceTestNameModal';
...
const EntranceTestNameList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this entrance test name?");
    ...
    const [items] = useState(["Entrance Test Name", "Entrance Test Full Name", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Entrance Test Name", "Entrance Test Full Name"]);
    const [ItemsRequired] = useState(["Entrance Test Name", "Entrance Test Full Name"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'shortname', label: 'Entrance Test Name', field: 'shortname', visible: true, required: true },
        { id: 'fullname', label: 'Entrance Test Full Name', field: 'fullname', visible: true, required: true },
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this entrance test name?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all entrance test name` : `${selectedRows.length} selected entrance test name`;
        setDeleteConfirmMessage(`Are you sure you want to delete this entrance test name (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const confirmDelete = () => {
        ...
        if (!sendPayload || sendPayload.length === 0) {
            toast.error("No entrance test name selected for deletion.");
            return;
        }
        dispatch(entranceTestNameDelete(sendPayload, (response, error) => {
            if (error) {
    ...
    const handleExport = () => {
        ...
        const fieldMapping = {
            ...
            "Entrance Test Full Name": "fullname",
        ...
        dispatch(entranceTestNameExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `EntranceTestName.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                />
                {showImport && (
                    <AddImportEntranceTestNameModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Entrance Test Name</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default EntranceTestNameList;