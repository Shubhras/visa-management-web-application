...
import { languageTestModuleNameList, languageTestModuleNameDelete, languageTestModuleNameExportData } from '../../../../store/master/testMaster/action';
import AddImportLanguageTestModuleNameModal from './AddImportLanguageTestModuleNameModal';
...
const LanguageTestModuleNameList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this language test module name?");
    ...
    const [items] = useState(["Language Test Module Name", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Language Test Module Name"]);
    const [ItemsRequired] = useState(["Language Test Module Name"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Language Test Module Name', field: 'name', visible: true, required: true },
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this language test module name?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all language test module names` : `${selectedRows.length} selected language test module name`;
        setDeleteConfirmMessage(`Are you sure you want to delete this language test module name (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const confirmDelete = () => {
        ...
        if (!sendPayload || sendPayload.length === 0) {
            toast.error("No language test module name selected for deletion.");
            return;
        }
        dispatch(languageTestModuleNameDelete(sendPayload, (response, error) => {
            if (error) {
    ...
    const handleExport = () => {
        ...
        const fieldMapping = {
            "Language Test Module Name": "name",
        ...
        dispatch(languageTestModuleNameExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `LanguageTestModuleName.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditLanguageTestModuleNameModal
                ...
                />
                {showImport && (
                    <AddImportLanguageTestModuleNameModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Language Test Module Name</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default LanguageTestModuleNameList;