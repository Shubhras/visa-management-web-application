...
import { entranceTestModuleNameList, entranceTestModuleNameDelete, entranceTestModuleNameExportData, entranceTestNameList } from '../../../../store/master/testMaster/action';
import AddImportEntranceTestModuleNameModal from './AddImportEntranceTestModuleNameModal';
import AddEditEntranceTestModuleNameModal from './AddEditEntranceTestModuleNameModal';
import { formatDateDDMMYYYY, formatDateDDMMYYYYTime } from '../../../../helper/utils/commanHelper';
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
const EntranceTestModuleNameList = () => {
    ...
    const clearAllOnlyHeaderFilters = () => setColumnFilters({ entranceTestName: [] })
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this entrance test module name?");
    ...
    const [items] = useState(["Entrance Test Name", "Entrance Test Module Name", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Entrance Test Name", "Entrance Test Module Name"]);
    const [ItemsRequired] = useState(["Entrance Test Name", "Entrance Test Module Name"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'shortname', label: 'Entrance Test Name', field: 'entranceTestName', visible: true, required: false, filterable: true },
        { id: 'fullname', label: 'Entrance Test Module Name', field: 'fullname', visible: true, required: false, filterable: false },
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this entrance test module name?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all entrance test module name` : `${selectedRows.length} selected entrance test module name`;
        setDeleteConfirmMessage(`Are you sure you want to delete this entrance test module name (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(entranceTestModuleNameExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `EntranceTestModuleName.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditEntranceTestModuleNameModal
                ...
                />
                {showImport && (
                    <AddImportEntranceTestModuleNameModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Entrance Test Module Name</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default EntranceTestModuleNameList;