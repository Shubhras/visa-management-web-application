...
import { entranceTestResultList, entranceTestResultDelete, entranceTestResultExportData } from '../../../../store/master/testMaster/action';
...
const EntranceTestResultList = () => {
    ...
    const [tableColumns] = useState([
        { id: 'shortname', label: 'Entrance Test Name', field: 'shortname', visible: true, required: true },
        { id: 'fullname', label: 'Entrance Test Module Name', field: 'fullname', visible: true, required: true },
        { id: 'result', label: 'Entrance Test Result', field: 'result', visible: true, required: true },
