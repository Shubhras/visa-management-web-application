...
const AddEditEntranceTestResultModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.result.trim()) {
            newErrors.result = 'Entrance test result is required';
            isValid = false;
        }
        ...
        if (validateForm()) {
            const sendPayload = mode === 'edit'
                ? {
                    ...
                    moduleName_id: formData.fullname,
            ...
            const action = mode === 'edit' ? entranceTestResultEdit : entranceTestResultAdd;
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 mb-20">
                                    ...
                                    <input
                                        ...
                                        className={`form-control radius-8 ${errors.result ? 'is-invalid' : ''}`}
                                        placeholder="Enter entrance test result"
                                    />
                                    {errors.result && (
                                        <div className="text-danger text-sm mt-1">
                                            {errors.result}
...
export default AddEditEntranceTestResultModal;