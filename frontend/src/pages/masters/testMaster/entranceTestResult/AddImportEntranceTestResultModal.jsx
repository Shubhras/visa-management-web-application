...
import { entranceTestResultImportData } from '../../../../store/master/testMaster/action';
...
const AddImportEntranceTestResultModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(entranceTestResultImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate entrance test result skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Entrance Test Name", "Entrance Test Module Name", "Entrance Test Result"],
                            sheetName: "EntranceTestResult",
                            fileName: "EntranceTestResult",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Entrance Test Name", "Entrance Test Module Name", "Entrance Test Result", "Reason"],
                            sheetName: "EntranceTestResult",
                            fileName: "EntranceTestResult",
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "EntranceTestResult",
                    items: ["Entrance Test Name", "Entrance Test Module Name", "Entrance Test Result", "Description"],
                    selectedItems: ["Entrance Test Name", "Entrance Test Module Name", "Entrance Test Result"],
                    ItemsRequired: ["Entrance Test Name", "Entrance Test Module Name", "Entrance Test Result"]
                }
                } />
            )}
        </>
...
export default AddImportEntranceTestResultModal;