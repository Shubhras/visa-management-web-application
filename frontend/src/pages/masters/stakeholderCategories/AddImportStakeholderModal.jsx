                ...
                if (response?.statusCode === 200 && response?.status === true) {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Stakeholder Category"],
                            sheetName: "StakeholderCategory",
                            fileName: "StakeholderCategory",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Stakeholder Category", "Description", "Reason"],
                            sheetName: "StakeholderCategory",
                            fileName: "StakeholderCategory",
                        };
                ...
                <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div className="modal-content radius-16 bg-base">
                        <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                            <h1 className="modal-title fs-5" id="StakeholderCategoriesModalLabel">
                                Upload Stakeholder Categories
                            </h1>
                            <button
                                type="button"
                                className="btn-close"
            ...
            </div>
            {
                showSampleExcelDownload && (
                    <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                        downloadFileName: "StakeholderCategory",
                        items: ["Stakeholder Category", "Description"],
                        selectedItems: ["Stakeholder Category"],
                        ItemsRequired: ["Stakeholder Category"]
                    }
                    } />
                )
            }
...
export default AddImportStakeholderModal;