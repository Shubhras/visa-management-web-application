...
const StakeholderCategoriesList = () => {
  ...
  const [items] = useState(["Stakeholder Category", "Description", "Modified On"]);
  ...
  const [tableColumns] = useState([
    { id: 'name', label: 'Stakeholder Category', field: 'name', visible: true, required: false },
  ...
  return (
    <>
      <MasterLayout>
        ...
        {showImport && (
          <AddImportStakeholderModal show={showImport} handleClose={handleCloseImport} />)}
        {showDeleteConfirm && (
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content" style={{ borderRadius: '10px' }}>
                ...
                <div className="modal-body">
                  {/* <p className="mb-0">Are you sure you want to delete this Stakeholder?</p> */}
                  {/* <p className="mb-0"> Are you sure you want to delete this Stakeholder ({selectedRows.length})?</p> */}
            ...
            <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
              <div className="modal-content radius-16 bg-base">
                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                  <h1 className="modal-title fs-5">Export Stakeholder Category</h1>
                  <button
                    type="button"
                    className="btn-close"
