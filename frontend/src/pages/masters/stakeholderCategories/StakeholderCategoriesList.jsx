...
import {
  ...
  stakeholderCategoryDelete,
  stakeholderCategoryExportData,
...
const StakeholderCategoriesList = () => {
  ...
  const [deleteConfirmMessage, setDeleteConfirmMessage] = useState(
    "Are you sure you want to delete this stakeholder category?"
  );
  ...
  const [selectedItems, setSelectedItems] = useState(["Stakeholder Category"]);
  const [ItemsRequired] = useState(["Stakeholder Category"]);
  ...
  const handleBulkDelete = () => {
    ...
    const message =
      selectAllOrNot === "all"
        ? `${tableState.total} all stakeholder category`
        : `${selectedRows.length} selected stakeholder category`;
    setDeleteConfirmMessage(
      `Are you sure you want to delete this stakeholder category (${message})?`
    );
    setShowDeleteConfirm(true);
  };
  const confirmDelete = () => {
      ...
      stakeholderCategoryDelete(sendPayload, (response, error) => {
        if (error) {
          ...
          if (response?.statusCode === 200 && response?.status === true) {
            ...
            setStakeholderListData((prevDepts) =>
  ...
  const handleExport = () => {
    ...
    dispatch(
      stakeholderCategoryExportData(sendPayload, (response, error) => {
        if (error) {
  ...
  return (
    <>
      <MasterLayout>
        {/* <Breadcrumb title="Stakeholder Category" subTitle="List" /> */}
              ...
              <div className="col-xl-6 col-lg-4 col-md-12">
                <div className="d-flex flex-wrap align-items-center gap-2">
                  ...
                  {selectedRows?.length > 0 &&
                    selectedRows?.length === stakeholderListData?.length && (
                      <>
                        <button
              ...
              <table className="table mb-0">
                ...
                <tbody>
                  {loading ? (
                    ...
                    stakeholderListData.map((rowItem, index) => (
                      <tr key={rowItem.uuid}>
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            <input
        ...
        <EditStakeholderCategories
          show={showEdit}
          handleCloseEdit={handleCloseEdit}
          rowSelectData={rowSelectData}
        />
        {showImport && (
          <AddImportStakeholderModal
            show={showImport}
