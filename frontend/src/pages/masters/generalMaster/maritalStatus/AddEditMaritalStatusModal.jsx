...
import { maritalStatusAdd, maritalStatusEdit } from '../../../../store/master/generalMasters/actions';

const AddEditMaritalStatusModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
...
export default AddEditMaritalStatusModal;