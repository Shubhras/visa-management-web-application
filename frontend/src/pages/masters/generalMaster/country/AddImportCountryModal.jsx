...
const AddImportCountryModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    dispatch(
      countryImportData(formData, (response, error) => {
        setLoading(false);
        if (error) {
              ...
              <div>
                ...
                {response?.duplicates?.length > 0 && (
                  <div style={{ marginTop: "6px" }}>
                    <strong>
                      Duplicate countrys skipped — the duplicate data from your
...
export default AddImportCountryModal;
