...
import { childrenStudyWorkRightsImportData } from "../../../../store/master/visaConditionsMaster/action";
...
const AddImportChildrenStudyWorkRightsModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(childrenStudyWorkRightsImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Children Study / Work Rights skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Children Study / Work Rights"],
                            sheetName: "ChildrenStudy/WorkRights",
                            fileName: "ChildrenStudy/WorkRights",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Children Study / Work Rights", "Reason"],
                            sheetName: "ChildrenStudy/WorkRights",
                            fileName: "ChildrenStudy/WorkRights",
                        };
        ...
        <>
                    ...
                    <div className="modal-content radius-16 bg-base">
                        <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                            <h1 className="modal-title fs-5" id="departmentModalLabel">
                                Upload Children Study / Work Rights
                            </h1>
                            <button
                                type="button"
                                className="btn-close"
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "ChildrenStudy/WorkRights",
                    items: ["Children Study / Work Rights", "Description"],
                    selectedItems: ["Children Study / Work Rights"],
                    ItemsRequired: ["Children Study / Work Rights"]
                }
                } />
            )}
        </>
...
export default AddImportChildrenStudyWorkRightsModal;