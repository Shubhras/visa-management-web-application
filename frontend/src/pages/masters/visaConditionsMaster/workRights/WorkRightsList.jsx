...
import { workRightsList, workRightsDelete, workRightsExportData } from "../../../../store/master/visaConditionsMaster/action";
import AddImportWorkRightsModal from './AddImportWorkRightsModal';
import AddEditWorkRightsModal from './AddEditWorkRightsModal';
import { formatDateDDMMYYYYTime } from '../../../../helper/utils/commanHelper';
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
import ResetButton from '../../../../components/comman/ResetButton';
const WorkRightsList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Work Rights?");
    ...
    const [items] = useState(["Work Rights", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Work Rights"]);
    const [ItemsRequired] = useState(["Work Rights"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Work Rights', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(workRightsList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Work Rights?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Work Rights` : `${selectedRows.length} selected Work Rights`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Work Rights (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(workRightsExportData(sendPayload, (response, error) => {
            if (error) {
    ...
    return (
        <>
            <MasterLayout>
                ...
                />
                {showImport && (
                    <AddImportWorkRightsModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Work Rights</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
