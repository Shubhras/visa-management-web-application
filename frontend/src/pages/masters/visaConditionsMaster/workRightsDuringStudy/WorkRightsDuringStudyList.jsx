...
import { workRightsDuringStudyList, workRightsDuringStudyDelete, workRightsDuringStudyExportData } from "../../../../store/master/visaConditionsMaster/action";
import AddImportWorkRightsDuringStudyModal from './AddImportWorkRightsDuringStudyModal';
import AddEditWorkRightsDuringStudyModal from './AddEditWorkRightsDuringStudyModal';
...
const WorkRightsDuringStudyList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Work Rights During Study?");
    ...
    const [items] = useState(["Work Rights During Study", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Work Rights During Study"]);
    const [ItemsRequired] = useState(["Work Rights During Study"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Work Rights During Study', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(workRightsDuringStudyList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Work Rights During Study?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Work Rights During Study` : `${selectedRows.length} selected Work Rights During Study`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Work Rights During Study (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(workRightsDuringStudyExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `WorkRightsDuringStudy.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditWorkRightsDuringStudyModal
                ...
                />
                {showImport && (
                    <AddImportWorkRightsDuringStudyModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Work Rights During Study</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default WorkRightsDuringStudyList;