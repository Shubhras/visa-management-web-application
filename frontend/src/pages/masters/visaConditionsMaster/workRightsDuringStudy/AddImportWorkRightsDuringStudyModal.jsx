...
import { workRightsDuringStudyImportData } from "../../../../store/master/visaConditionsMaster/action";
...
const AddImportWorkRightsDuringStudyModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(workRightsDuringStudyImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Work Rights During Study skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Work Rights During Study"],
                            sheetName: "WorkRightsDuringStudy",
                            fileName: "WorkRightsDuringStudy",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Work Rights During Study", "Reason"],
                            sheetName: "WorkRightsDuringStudy",
                            fileName: "WorkRightsDuringStudy",
                        };
        ...
        <>
                    ...
                    <div className="modal-content radius-16 bg-base">
                        <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                            <h1 className="modal-title fs-5" id="departmentModalLabel">
                                Upload Work Rights During Study
                            </h1>
                            <button
                                type="button"
                                className="btn-close"
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "WorkRightsDuringStudy",
                    items: ["Work Rights During Study", "Description"],
                    selectedItems: ["Work Rights During Study"],
                    ItemsRequired: ["Work Rights During Study"]
                }
                } />
            )}
        </>
...
export default AddImportWorkRightsDuringStudyModal;