...
import { childrenApplyWithCandidateList, childrenApplyWithCandidateDelete, childrenApplyWithCandidateExportData } from "../../../../store/master/visaConditionsMaster/action";
import AddImportChildrenCanApplywithCandidateModal from './AddImportChildrenCanApplywithCandidateModal';
import AddEditChildrenCanApplywithCandidateModal from './AddEditChildrenCanApplywithCandidateModal';
import { formatDateDDMMYYYYTime } from '../../../../helper/utils/commanHelper';
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
import ResetButton from '../../../../components/comman/ResetButton';
const ChildrenCanApplywithCandidateList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Children Can Apply with Candidate?");
    ...
    const [items] = useState(["Children Can Apply with Candidate", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Children Can Apply with Candidate"]);
    const [ItemsRequired] = useState(["Children Can Apply with Candidate"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Children Can Apply with Candidate?', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(childrenApplyWithCandidateList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Children Can Apply with Candidate?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Children Can Apply with Candidate` : `${selectedRows.length} selected Children Can Apply with Candidate`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Children Can Apply with Candidate (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        const fieldMapping = {
            "Children Can Apply with Candidate": "name",
        ...
        dispatch(childrenApplyWithCandidateExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `ChildrenCanApplywithCandidate.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditChildrenCanApplywithCandidateModal
                ...
                />
                {showImport && (
                    <AddImportChildrenCanApplywithCandidateModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Children Can Apply with Candidate</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default ChildrenCanApplywithCandidateList;