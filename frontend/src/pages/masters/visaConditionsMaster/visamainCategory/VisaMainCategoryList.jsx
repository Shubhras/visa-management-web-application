...
import { visaMainCategoryList, visaMainCategoryDelete, visaMainCategoryExportData } from "../../../../store/master/visaConditionsMaster/action";
import AddImportVisaMainCategoryModal from './AddImportVisaMainCategoryModal';
import AddEditVisaMainCategoryModal from './AddEditVisaMainCategoryModal';
import { formatDateDDMMYYYYTime } from '../../../../helper/utils/commanHelper';
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
import ResetButton from '../../../../components/comman/ResetButton';
const VisaMainCategoryList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Visa Main Category?");
    ...
    const [items] = useState(["Visa Main Category", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Visa Main Category"]);
    const [ItemsRequired] = useState(["Visa Main Category"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Visa Main Category', field: 'name', visible: true, required: false },
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Visa Main Category?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Visa Main Category` : `${selectedRows.length} selected Visa Main Category`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Visa Main Category (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(visaMainCategoryExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `VisaMainCategory.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                />
                {showImport && (
                    <AddImportVisaMainCategoryModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Visa Main Category</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default VisaMainCategoryList;