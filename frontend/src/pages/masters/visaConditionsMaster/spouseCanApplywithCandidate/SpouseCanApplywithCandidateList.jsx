...
import { spouseApplyWithCandidateList, spouseApplyWithCandidateDelete, spouseApplyWithCandidateExportData } from "../../../../store/master/visaConditionsMaster/action";
import AddImportSpouseCanApplywithCandidateModal from './AddImportSpouseCanApplywithCandidateModal';
import AddEditSpouseCanApplywithCandidateModal from './AddEditSpouseCanApplywithCandidateModal';
import { formatDateDDMMYYYYTime } from '../../../../helper/utils/commanHelper';
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
import ResetButton from '../../../../components/comman/ResetButton';
const SpouseCanApplywithCandidateList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Spouse Can Apply with Candidate?");
    ...
    const [items] = useState(["Spouse Can Apply with Candidate", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Spouse Can Apply with Candidate"]);
    const [ItemsRequired] = useState(["Spouse Can Apply with Candidate"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Spouse Can Apply with Candidate?', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(spouseApplyWithCandidateList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Spouse Can Apply with Candidate?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Spouse Can Apply with Candidate` : `${selectedRows.length} selected Spouse Can Apply with Candidate`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Spouse Can Apply with Candidate (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        const fieldMapping = {
            "Spouse Can Apply with Candidate": "name",
        ...
        dispatch(spouseApplyWithCandidateExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `SpouseCanApplywithCandidate.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditSpouseCanApplywithCandidateModal
                ...
                />
                {showImport && (
                    <AddImportSpouseCanApplywithCandidateModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Spouse Can Apply with Candidate</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default SpouseCanApplywithCandidateList;