...
import { spouseVisaCategoryList, spouseVisaCategoryDelete, spouseVisaCategoryExportData } from "../../../../store/master/visaConditionsMaster/action";
import AddImportSpouseVisaCategoryModal from './AddImportSpouseVisaCategoryModal';
import AddEditSpouseVisaCategoryModal from './AddEditSpouseVisaCategoryModal';
...
const SpouseVisaCategoryList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Spouse Visa Category?");
    ...
    const [items] = useState(["Spouse Visa Category", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Spouse Visa Category"]);
    const [ItemsRequired] = useState(["Spouse Visa Category"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Spouse Visa Category', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(spouseVisaCategoryList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Spouse Visa Category?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Spouse Visa Category` : `${selectedRows.length} selected Spouse Visa Category`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Spouse Visa Category (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        const fieldMapping = {
            "Spouse Visa Category": "visamain_name",
        ...
        dispatch(spouseVisaCategoryExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `SpouseVisaCategory.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditSpouseVisaCategoryModal
                ...
                />
                {showImport && (
                    <AddImportSpouseVisaCategoryModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Spouse Visa Category</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default SpouseVisaCategoryList;