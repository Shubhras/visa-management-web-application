...
import { workRightsDuringVacationImportData } from "../../../../store/master/visaConditionsMaster/action";
...
const AddImportWorkRightsDuringVacationModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(workRightsDuringVacationImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Work Rights During Vacation skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Work Rights During Vacation"],
                            sheetName: "WorkRightsDuringVacation",
                            fileName: "WorkRightsDuringVacation",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Work Rights During Vacation", "Reason"],
                            sheetName: "WorkRightsDuringVacation",
                            fileName: "WorkRightsDuringVacation",
                        };
        ...
        <>
                    ...
                    <div className="modal-content radius-16 bg-base">
                        <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                            <h1 className="modal-title fs-5" id="departmentModalLabel">
                                Upload Work Rights During Vacation
                            </h1>
                            <button
                                type="button"
                                className="btn-close"
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "WorkRightsDuringVacation",
                    items: ["Work Rights During Vacation", "Description"],
                    selectedItems: ["Work Rights During Vacation"],
                    ItemsRequired: ["Work Rights During Vacation"]
                }
                } />
            )}
        </>
...
export default AddImportWorkRightsDuringVacationModal;