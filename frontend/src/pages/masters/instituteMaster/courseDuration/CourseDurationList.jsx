...
import { courseDurationList, courseDurationDelete, courseDurationExportData, courseLevelList } from "../../../../store/master/instituteMaster/action";
...
const CourseDurationList = () => {
    ...
    const [tableColumns] = useState([
        { id: 'courselevel_id', label: 'Course Level', field: 'courseLevel', visible: true, required: false, filterable: true },
        { id: 'valid_duration_value', label: 'Course Duration Value', field: 'valid_duration_value', visible: true, required: false, filterable: false },
        { id: 'valid_duration_unit', label: 'Course Duration Unit', field: 'valid_duration_unit', visible: true, required: false, filterable: false },
