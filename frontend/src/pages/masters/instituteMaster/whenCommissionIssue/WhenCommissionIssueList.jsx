...
import { whenCommissionIssueList, whenCommissionIssueDelete, whenCommissionIssueExportData } from "../../../../store/master/instituteMaster/action";
import AddImportWhenCommissionIssueModal from './AddImportWhenCommissionIssueModal';
import AddEditWhenCommissionIssueModal from './AddEditWhenCommissionIssueModal';
import { formatDateDDMMYYYYTime } from '../../../../helper/utils/commanHelper';
import { useGlobalSearch } from '../../../../components/comman/GlobalSearchContext';
const WhenCommissionIssueList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this when commission issue?");
    ...
    const [items] = useState(["When Commission Issue", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["When Commission Issue"]);
    const [ItemsRequired] = useState(["When Commission Issue"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'When Commission Issue', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(whenCommissionIssueList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this When Commission Issue?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all When Commission Issue` : `${selectedRows.length} selected When Commission Issue`;
        setDeleteConfirmMessage(`Are you sure you want to delete this When Commission Issue (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(whenCommissionIssueExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `WhenCommissionIssue.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                <AddEditWhenCommissionIssueModal
                ...
                />
                {showImport && (
                    <AddImportWhenCommissionIssueModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export When Commission Issue</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default WhenCommissionIssueList;