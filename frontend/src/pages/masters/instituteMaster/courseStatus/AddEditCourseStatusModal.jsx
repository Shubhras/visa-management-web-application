...
import { courseStatusAdd, courseStatusEdit } from "../../../../store/master/instituteMaster/action";
import { toast } from "react-toastify";

const AddEditCourseStatusModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.departmentName.trim()) {
            newErrors.departmentName = 'Course status is required';
            isValid = false;
        }
                ...
                <div className="modal-content radius-16 bg-base">
                    <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                        <h1 className="modal-title fs-5" id="departmentModalLabel">
                            {mode === 'edit' ? 'Edit Course Status' : 'Add Course Status'}
                        </h1>
                        <button
                            type="button"
                            className="btn-close"
...
export default AddEditCourseStatusModal;