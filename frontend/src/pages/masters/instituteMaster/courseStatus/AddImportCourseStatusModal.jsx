...
const AddImportCourseStatusModal = ({ show, handleClose }) => {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate Course Status skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
        ...
        <>
            ...
            {showSampleExcelDownload && (
                <CommanSampleExcelDownloadModal show={showSampleExcelDownload} handleClose={handleCloseSampleExcelDownload} prepareData={{
                    downloadFileName: "CourseStatus",
                    items: ["Course Status", "Description"],
                    selectedItems: ["Course Status"],
                    ItemsRequired: ["Course Status"]
                }
                } />
            )}
        </>
...
export default AddImportCourseStatusModal;