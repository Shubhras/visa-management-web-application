...
import { courseDividedInList, courseDividedInDelete, courseDividedInExportData } from "../../../../store/master/instituteMaster/action";
import AddImportCourseDividedInModal from './AddImportCourseDividedInModal';
import AddEditCourseDividedInModal from './AddEditCourseDividedInModal';
...
const CourseDividedInList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Course Divided In?");
    ...
    const [items] = useState(["Course Divided In", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Course Divided In"]);
    const [ItemsRequired] = useState(["Course Divided In"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Course Divided In', field: 'name', visible: true, required: false },
    ...
    const fetchDepartmentList = () => {
        ...
        dispatch(courseDividedInList(params, (response, error) => {
            setLoading(false);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Course Divided In?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Course Divided In` : `${selectedRows.length} selected Course Divided In`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Course Divided In (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(courseDividedInExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `CourseDividedIn.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                ...
                />
                {showImport && (
                    <AddImportCourseDividedInModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Course Divided In</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default CourseDividedInList;