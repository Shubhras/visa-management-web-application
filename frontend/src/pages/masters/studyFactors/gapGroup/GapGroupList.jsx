...
import AddEditGapGroupModal from './AddEditGapGroupModal';
import AddImportGapGroupModal from './AddImportGapGroupModal';
...
const GapGroupList = () => {
  ...
  const confirmDelete = () => {
    ...
    dispatch(gapGroupDelete(payloadSend, (response, error) => {
      if (error) {
  ...
  return (
    <>
      <MasterLayout>
        ...
        {/* Import Modal */}
        {showImport && (
          <AddImportGapGroupModal show={showImport} handleClose={handleCloseImport} />
        )}
