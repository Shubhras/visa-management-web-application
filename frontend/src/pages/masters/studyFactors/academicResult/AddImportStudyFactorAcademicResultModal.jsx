...
import { ageImportData, studyFactorAcademicResultImportData } from "../../../../store/actions";
const AddImportStudyFactorAcademicResultModal = ({ show, handleClose }) => {
              ...
              <div>
                ...
                {response?.duplicates?.length > 0 && (
                  <div style={{ marginTop: "6px" }}>
                    <strong>
                      Duplicate state skipped — the duplicate data from your
          ...
          <div className="modal-content radius-16 bg-base">
            <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
              <h1 className="modal-title fs-5" id="StateModalLabel">
                Upload Study Factor : Academic Result
              </h1>
              <button
                type="button"
                className="btn-close"
...
export default AddImportStudyFactorAcademicResultModal;
