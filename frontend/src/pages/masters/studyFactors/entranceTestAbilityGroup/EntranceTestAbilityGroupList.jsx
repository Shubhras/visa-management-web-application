...
const EntranceTestAbilityGroupList = () => {
  ...
  const confirmDelete = () => {
    ...
    dispatch(entranceTestAbilityGroupDelete(payloadSend, (response, error) => {
      if (error) {
  ...
  return (
    <>
      <MasterLayout>
        ...
        {/* Add/Edit Modal */}
        <AddEditEntranceTestAbilityGroupModal
        ...
        {/* Import Modal */}
        {showImport && (
          <AddImportEntranceTestAbilityGroupModal show={showImport} handleClose={handleCloseImport} />
        )}
...
export default EntranceTestAbilityGroupList;
