...
import { backlogsGroupImportData, factorForImportData } from "../../../../store/actions";
import { exportToExcelDuplicate, exportToExcelWrongData } from "../../../../helper/utils/commanHelper";
const AddImportBacklogsGroupModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    dispatch(
      backlogsGroupImportData(formData, (response, error) => {
        setLoading(false);
        if (error) {
...
export default AddImportBacklogsGroupModal;
