...
import { ageGroupImportData, factorForImportData } from "../../../../store/actions";
import { exportToExcelDuplicate, exportToExcelWrongData } from "../../../../helper/utils/commanHelper";
const AddImportAgeGroupModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    dispatch(
      ageGroupImportData(formData, (response, error) => {
        setLoading(false);
        if (error) {
  ...
  return (
    <>
      <div
        ...
        tabIndex={-1}
        role="dialog"
        aria-labelledby="agegroupModalLabel"
        aria-hidden={!show}
      >
        <div
      ...
      {showSampleExcelDownload && (
        <CommanSampleExcelDownloadModal
          ...
          prepareData={{
            downloadFileName: "Age Group",
            items: ["Age Group", "Description"],
            selectedItems: ["Age Group"],
            ItemsRequired: ["Age Group"],
          }}
        />
      )}
    </>
...
export default AddImportAgeGroupModal;
