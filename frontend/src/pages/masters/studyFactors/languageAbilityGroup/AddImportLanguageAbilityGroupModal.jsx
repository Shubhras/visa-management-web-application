...
import { languageAbilityGroupImportData } from "../../../../store/actions";
import { exportToExcelDuplicate, exportToExcelWrongData } from "../../../../helper/utils/commanHelper";
const AddImportLanguageAbilityGroupModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    dispatch(
      languageAbilityGroupImportData(formData, (response, error) => {
        setLoading(false);
        if (error) {
          ...
          if (response?.statusCode === 200 && response?.status === true) {
              ...
              <div>
                ...
                {response?.duplicates?.length > 0 && (
                  <div style={{ marginTop: "6px" }}>
                    <strong>
                      Duplicate Course Divided In skipped — the duplicate data
            ...
            if (response?.duplicates?.length > 0) {
              const prepareData = {
                ...
                headers: ["Language Ability Group"],
                sheetName: "LanguageAbilityGroup",
                fileName: "LanguageAbilityGroup",
              };
            ...
            if (response?.skipped_rows?.length > 0) {
              const prepareData = {
                ...
                headers: ["Language Ability Group", "Reason"],
                sheetName: "LanguageAbilityGroup",
                fileName: "LanguageAbilityGroup",
              };
  ...
  return (
    <>
      <div
        ...
        tabIndex={-1}
        role="dialog"
        aria-labelledby="gapgroupModalLabel"
        aria-hidden={!show}
      >
        <div
...
export default AddImportLanguageAbilityGroupModal;
