...
import { priorityTypeAdd } from '../../../store/master/actions';
import { toast } from "react-toastify";
const AddPriorityType = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      setLoading(true);
      dispatch(priorityTypeAdd(sendPayload, (response, error) => {
        setLoading(false);
        if (error) {
...
export default AddPriorityType;