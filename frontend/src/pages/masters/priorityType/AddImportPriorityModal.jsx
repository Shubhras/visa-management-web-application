...
const AddImportPriorityModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    dispatch(
      priorityTypeImportData(formData, (response, error) => {
        setLoading(false);
        if (error) {
              ...
              <div>
                ...
                {response?.duplicates?.length > 0 && (
                  <div style={{ marginTop: "6px" }}>
                    <strong>
                      Duplicate priority type skipped — the duplicate data from
    ...
    <>
      ...
      {showSampleExcelDownload && (
        <CommanSampleExcelDownloadModal
          ...
          prepareData={{
            downloadFileName: "Priority",
            items: ["Priority", "Description"],
            selectedItems: ["Priority"],
            ItemsRequired: ["Priority"],
          }}
        />
      )}
    </>
