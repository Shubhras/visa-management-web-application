...
const AcademicResultTypeList = () => {
  ...
  const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this academic result type?");
  ...
  const [tableColumns] = useState([
    { id: 'name', label: 'Academic Result Type', field: 'name', visible: true, required: false },
    { id: 'dataType', label: 'Data Type', field: 'dataType', visible: true, required: false },
  ...
  const handleDelete = (uuid) => {
    ...
    setDeleteConfirmMessage(`Are you sure you want to delete this academic result type?`);
  };
  ...
  const handleBulkDelete = () => {
    ...
    const message = selectAllOrNot === "all" ? `${tableState.total} all academic result types` : `${selectedRows.length} selected academic result Types`;
    setDeleteConfirmMessage(`Are you sure you want to delete this academic result type (${message})?`);
    setShowDeleteConfirm(true);
  };
  ...
  const handleExport = () => {
    ...
    dispatch(academicResultTypeExportData(sendPayload, (response, error) => {
      if (error) {
        ...
        if (response?.status === 200) {
          ...
          link.href = url;
          link.download = `AcademicResultType.xlsx`;
            ...
            <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
              <div className="modal-content radius-16 bg-base">
                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                  <h1 className="modal-title fs-5">Export Academic Result Type</h1>
                  <button
                    type="button"
                    className="btn-close"
...
export default AcademicResultTypeList;