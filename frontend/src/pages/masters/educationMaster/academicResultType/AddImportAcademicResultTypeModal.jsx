...
import { academicResultTypeImportData } from '../../../../store/master/educationMaster/action';
...
const AddImportAcademicResultTypeModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(academicResultTypeImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate academic result types skipped — the duplicate data from your uploaded file has been exported into an .xlsx file.</strong>
                                </div>
                            )}
                        </div>,
                        {
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Academic Result Type", "Data Type","Description","Reason"],
                            sheetName: "AcademicResultType",
                            fileName: "AcademicResultType",
                        };
...
export default AddImportAcademicResultTypeModal;