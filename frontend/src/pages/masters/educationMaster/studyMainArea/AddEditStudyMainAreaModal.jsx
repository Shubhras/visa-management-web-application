...
import { studyMainAreaAdd, studyMainAreaEdit } from '../../../../store/master/educationMaster/action';
import { toast } from "react-toastify";

const AddEditStudyMainAreaModal = ({ show, handleClose, mode = 'add', rowData = null }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      const action = mode === 'edit' ? studyMainAreaEdit : studyMainAreaAdd;
        ...
        <div className="modal-content radius-16 bg-base">
          <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
            <h1 className="modal-title fs-5" id="departmentModalLabel">
              {mode === 'edit' ? 'Edit Study Main Area' : 'Add Study Main Area'}
            </h1>
            <button
              type="button"
              className="btn-close"
...
export default AddEditStudyMainAreaModal;