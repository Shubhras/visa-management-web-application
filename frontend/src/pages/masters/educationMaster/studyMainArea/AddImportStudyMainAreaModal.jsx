...
import { studyMainAreaImportData } from '../../../../store/master/educationMaster/action';
...
const AddImportStudyMainAreaModal = ({ show, handleClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        dispatch(studyMainAreaImportData(formData, (response, error) => {
            setLoading(false);
            if (error) {
                ...
                if (response?.statusCode === 200 && response?.status === true) {
                    ...
                    if (response?.duplicates?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Study Main Area"],
                            sheetName: "StudyMainArea",
                            fileName: "StudyMainArea",
                        };
                    ...
                    if (response?.skipped_rows?.length > 0) {
                        const prepareData = {
                            ...
                            headers: ["Study Main Area","Description","Reason"],
                            sheetName: "StudyMainArea",
                            fileName: "StudyMainArea",
                        };
...
export default AddImportStudyMainAreaModal;