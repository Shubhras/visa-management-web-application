...
const StudyMainAreaList = () => {
  ...
  const handleExport = () => {
    ...
    dispatch(studyMainAreaExportData(sendPayload, (response, error) => {
      if (error) {
  ...
  return (
    <>
      <MasterLayout>
        ...
        />
        {showImport && (
          <AddImportStudyMainAreaModal show={showImport} handleClose={handleCloseImport} />)}
        {showDeleteConfirm && (
...
export default StudyMainAreaList;