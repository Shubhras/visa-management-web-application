...
import { studySpecialisationList, studySpecialisationDelete, studySpecialisationExportData, studyMainAreaList, studyMajorAreaList } from "../../../../store/master/educationMaster/action";
...
const StudySpecialisationList = () => {
  ...
  const fetchStudyMajorAreaDropdown = () => {
    const params = {
      page: 1,
      limit: 2000,
      search: "",
  ...
  const [tableColumns] = useState([
    { id: 'mainarea_name', label: 'Study Main Area', field: 'studyMainArea', visible: true, required: false, filterable: true },
    { id: 'majorarea_name', label: 'Study Major Area', field: 'studyMajorArea', visible: true, required: false, filterable: true },
    { id: 'studyspecialisation', label: 'Study Specialisation', field: 'studyspecialisation', visible: true, required: false, filterable: false },
  ...
  const fetchDepartmentList = () => {
    ...
    const params = {
      ...
      studyMajorArea: columnFilters.studyMajorArea.length > 0 ? columnFilters.studyMajorArea : null,
    };
