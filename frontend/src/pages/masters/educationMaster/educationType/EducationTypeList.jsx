...
const EducationTypeList = () => {
    ...
    const [tableColumns] = useState([
        { id: 'educationType', label: 'Education Type', field: 'educationType', visible: true, required: true },
    ...
    const confirmDelete = () => {
        ...
        dispatch(educationTypeDelete(payloadSend, (response, error) => {
            if (error) {
                                    ...
                                    {loading ? (
                                        ...
                                        departments.map((rowItem, index) => (
                                            <tr key={rowItem.uuid}>
                                                ...
                                                {isColumnVisible('educationType') && (
                                                    <td><span>{rowItem.educationType}</span></td>
                                                )}
