              ...
              <table className="table mb-0"  >
                <thead >
                  <tr>
                    ...
                    <th scope="col" className='sorting-th' onClick={() => handleSort('educationlevel_detail')}>
                      <div className="d-flex align-items-center">
                        Education Level
                        {getSortIcon('educationlevel_detail')}
                      </div>
                    </th>
                    <th scope="col" className='sorting-th' onClick={() => handleSort('durations')}>
                      <div className="d-flex align-items-center">
                        Education Duration (Months)
