...
const EducationLevelCodeList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this education level code?");
    ...
    const [items] = useState(["Education Level Code", "Description", "Modified On"]);
    const [selectedItems, setSelectedItems] = useState(["Education Level Code"]);
    const [ItemsRequired] = useState(["Education Level Code"]);

    // Table columns configuration
    const [tableColumns] = useState([
        { id: 'name', label: 'Education Level Code', field: 'name', visible: true, required: true },
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this education level code?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all education level codes` : `${selectedRows.length} selected education level codes`;
        setDeleteConfirmMessage(`Are you sure you want to delete this education level code (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    const handleExport = () => {
        ...
        dispatch(educationLevelCodeExportData(sendPayload, (response, error) => {
            if (error) {
                ...
                if (response?.status === 200) {
                    ...
                    link.href = url;
                    link.download = `EducationLevelCode.xlsx`;
    ...
    return (
        <>
            <MasterLayout>
                {/* <Breadcrumb title="Education Level Code" subTitle="List" /> */}
                ...
                <AddEditEducationLevelCodeModal
                ...
                />
                {showImport && (
                    <AddImportEducationLevelCodeModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Education Level Code</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
...
export default EducationLevelCodeList;