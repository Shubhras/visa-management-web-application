...
const AddImportECAForModal = ({ show, handleClose }) => {
    ...
    const handleExportToExcel = (duplicatesData) => {
        ...
        saveAs(blob, `ECAFor-Duplicate-Data.xlsx`);
    };
    // Handle modal close
    const onClose = () => {
        setFile(null);
...
export default AddImportECAForModal;