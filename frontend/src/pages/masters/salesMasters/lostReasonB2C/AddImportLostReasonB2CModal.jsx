...
const AddImportLostReasonB2CModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    dispatch(
      lostReasonB2CImportData(formData, (response, error) => {
        setLoading(false);
        if (error) {
              ...
              <div>
                ...
                {response?.duplicates?.length > 0 && (
                  <div style={{ marginTop: "6px" }}>
                    <strong>
                      Duplicate lost reason (B2C) skipped — the duplicate data
  ...
  return (
    <>
      ...
      {showSampleExcelDownload && (
        <CommanSampleExcelDownloadModal
