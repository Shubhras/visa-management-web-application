...
const AddImportActivityModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    dispatch(
      activityTypeImportData(formData, (response, error) => {
        setLoading(false);
        if (error) {
              ...
              <div>
                ...
                {response?.duplicates?.length > 0 && (
                  <div style={{ marginTop: "6px" }}>
                    <strong>
                      Duplicate activity type skipped — the duplicate data from
    ...
    <>
      ...
      {showSampleExcelDownload && (
        <CommanSampleExcelDownloadModal
          ...
          prepareData={{
            downloadFileName: "ActivityType",
            items: ["Activity Type", "Description"],
            selectedItems: ["Activity Type"],
            ItemsRequired: ["Activity Type"],
          }}
        />
      )}
    </>
