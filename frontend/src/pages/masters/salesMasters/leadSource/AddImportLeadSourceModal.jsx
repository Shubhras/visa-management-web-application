...
const AddImportLeadSourceModal = ({ show, handleClose }) => {
    ...
    const handleExportToExcel = (duplicatesData) => {
        ...
        saveAs(blob, `LeadSource_${new Date().toISOString().split("T")[0]}.xlsx`);
    };
    // Handle modal close
    const onClose = () => {
        setFile(null);
    ...
    const handleDownloadSample = () => {
        const fileUrl = 'assets/simplefile/LeadSource.xlsx'; // Update this path according to your project structure

        const link = document.createElement('a');
        link.href = fileUrl;
        link.download = 'LeadSource.xlsx'; // Downloaded file name
    ...
    return (
        <div
            ...
            tabIndex={-1}
            role="dialog"
            aria-labelledby="LeadSourceModalLabel"
            aria-hidden={!show}
        >
...
export default AddImportLeadSourceModal;