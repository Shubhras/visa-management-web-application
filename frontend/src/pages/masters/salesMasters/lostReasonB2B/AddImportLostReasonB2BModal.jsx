...
const AddImportLostReasonB2BModal = ({ show, handleClose }) => {
                        ...
                        <div>
                            ...
                            {response?.duplicates?.length > 0 && (
                                <div style={{ marginTop: '6px' }}>
                                    <strong>Duplicate lost reason B2B skipped:</strong>
                                    <br />
    ...
    const handleDownloadSample = () => {
        const fileUrl = 'assets/simplefile/lostReasonB2B.xlsx'; // Update this path according to your project structure

        const link = document.createElement('a');
        link.href = fileUrl;
        link.download = 'lostReasonB2B._sample.xlsx'; // Downloaded file name
