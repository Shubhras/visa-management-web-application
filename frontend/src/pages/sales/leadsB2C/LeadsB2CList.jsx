...
const LeadsB2CList = () => {
    ...
    const [deleteConfirmMessage, setDeleteConfirmMessage] = useState("Are you sure you want to delete this Leads B2C?");
    ...
    const [items] = useState(["Lead ID", "First Name", "Last Name", "Mobile No", "Email ID", "Sales Team", "Sales Person"]);
    ...
    const [tableColumns] = useState([
        ...
        { id: 'emailId', label: 'Email ID', field: 'emailId', visible: true, required: false },
        { id: 'salesTeam', label: 'Sales Team', field: 'salesTeam', visible: true, required: false },
        { id: 'salesPerson', label: 'Sales Person', field: 'salesPerson', visible: true, required: false },
    ]);
    ...
    const handleDelete = (uuid) => {
        ...
        setDeleteConfirmMessage(`Are you sure you want to delete this Leads B2C?`);
    };
    ...
    const handleBulkDelete = () => {
        ...
        const message = selectAllOrNot === "all" ? `${tableState.total} all Leads B2C` : `${selectedRows.length} selected Leads B2C`;
        setDeleteConfirmMessage(`Are you sure you want to delete this Leads B2C (${message})?`);
        setShowDeleteConfirm(true);
    };
    ...
    return (
        <>
            <MasterLayout>
                                        ...
                                        departments.map((rowItem, index) => (
                                            <tr key={rowItem.uuid}>
                                                ...
                                                {isColumnVisible('leadId') && (
                                                    <td><span>{rowItem.leadId}</span></td>
                                                )}

                                                {isColumnVisible('firstName') && (
                                                    <td><span>{rowItem.firstName}</span></td>
                                                )}

                                                {isColumnVisible('lastName') && (
                                                    <td><span>{rowItem.lastName}</span></td>
                                                )}

                                                {isColumnVisible('mobileNo') && (
                                                    <td><span>{rowItem.mobileNo}</span></td>
                                                )}

                                                {isColumnVisible('emailId') && (
                                                    <td><span>{rowItem.emailId}</span></td>
                                                )}

                                                {isColumnVisible('salesTeam') && (
                                                    <td><span>{rowItem.salesTeam}</span></td>
                                                )}

                                                {isColumnVisible('salesPerson') && (
                                                    <td><span>{rowItem.salesPerson}</span></td>
                                                )}
                ...
                {showImport && (
                    <AddImportLeadsB2CModal show={showImport} handleClose={handleCloseImport} />)}
                {showDeleteConfirm && (
                        ...
                        <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div className="modal-content radius-16 bg-base">
                                <div className="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                                    <h1 className="modal-title fs-5">Export Leads B2C</h1>
                                    <button
                                        type="button"
                                        className="btn-close"
