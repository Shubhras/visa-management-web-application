...
class StudyFactorAcademicResult(models.Model):
    ...
    study_academic_result_group = models.ForeignKey(AcademicResultGroup, on_delete=models.CASCADE, related_name="academic_results", to_field='uuid',db_column='academic_result_group_uuid')
    ...
    def __str__(self):
        return f"{self.study_academic_result_group.name} - Academic Result"
...
class StudyFactorBacklogs(models.Model):
    ...
    study_backlogs_group = models.ForeignKey("master.BacklogsGroup", on_delete=models.CASCADE, related_name="study_backlogs")
...
class StudyFactorLanguageAbility(models.Model):
    ...
    factor_for = models.ForeignKey(FactorFor, on_delete=models.CASCADE)
    study_language_ability_group = models.ForeignKey(LanguageAbilityGroup, on_delete=models.CASCADE)
...
class StudyFactorEntranceTestAbility(models.Model):
    ...
    factor_for = models.ForeignKey(FactorFor, on_delete=models.CASCADE)
    study_entrance_test_ability_group = models.ForeignKey('EntranceTestAbilityGroup', on_delete=models.CASCADE)
