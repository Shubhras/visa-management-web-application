...
urlpatterns = [
    ...
    path('course-durations/update/<uuid:uuid>/', CourseDurationUpdateAPIView.as_view(), name='course-duration-update'),
    path('course-durations/delete/<uuid:uuid>/', CourseDurationDeleteAPIView.as_view(), name='course-duration-delete'),
    ...
    path('course-level/update/<uuid:uuid>/', CourseLevelUpdateAPIView.as_view(), name='course-Level-update'),
    path('course-level/delete/<uuid:uuid>/', CourseLevelDeleteAPIView.as_view(), name='course-Level-delete'),
