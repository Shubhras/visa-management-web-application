...
urlpatterns = [
    ...
    path("processtype/export/", ProcessTypeExportAPIView.as_view(), name="process_type_export"),
    ...
    path("paymentto/export/", PaymentToExportAPIView.as_view(), name="payment_to_export"),
    ...
    path("civilidname/export/", CivilIdNameExportAPIView.as_view(), name="civil_id_name_export"),
    path("civilidname/import/", CivilIdNameImportAPIView.as_view(), name="civil_id_name_import"),
